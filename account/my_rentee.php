        ...
        <div class="row"> <!--div row -->
              <div class="col-sm-12">
                <span class="hidden-xs">
                  <h1 class="page-header">My Rentee                      
                  </h1>
                </span>
                <span class="visible-xs">
                  <h3 class="page-header">My Rentee                   
                  </h3>
                </span>
              </div>
          </div> <!-- end of div row -->
                ...
                <div class="col-sm-12">
                  <div class="row"> <!-- div 2 row -->
                    ...
                    <div class = "content">
                      ...
                      <tbody>  
                      <?php                       
                      $order->my_rented_items($userid);
                      foreach ($order->rented_items as $key => $value) {
                        ?>
                        <tr>
                          <td><a href="<?php echo $address['rent_detail']."?"."ref=".$value['o_no']."&"."pid=".$value['pid'];?>">
                            <?php echo $value['o_no'];?></a></td>
                          <td><img class=" img-thumbnail" src="<?php echo $value['pic'];?>" alt=""></td>
                          <td><?php echo $value['qty'];?></td>
                          <td><?php echo date('M j Y',
                     strtotime($value['r_date']));?></td>
