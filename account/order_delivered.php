<?php   
   ...
   $productid = "";
   if(isset($_POST['o_deliver'])){
    if($_POST['o_deliver'] == "Confirm"){
      $order_no = $_POST['o_no'];
      $productid = $_POST['p_id'];
      $buyer_email = $_POST['mail'];
      echo $productid;
   ...
   if($order->shipped_item($order_no,$productid)){
	...
	$mail->Body.="<tr>
      ...
      $mail->Body.="<br>";
      $mail->Body.="This is for test purposes. If the email has been wrongly sent it to you. I would like to apologize.";
